...
XX.1..XX.4 bootstrap shipped in commit `c57a526` on branch `round2/phase-xx-atomic-bootstrap`. XX.5..XX.11 remain.
...
Round-2 closeout: ZZ.A..ZZ.H shipped on branch `round2/phase-zz-multi-origin-finish` (commit pinned below).
