...
Round-2 partial close-out: BBB.1, BBB.2, BBB.5, BBB.7, BBB.8, BBB.9, BBB.14 (override + attach + reminder) + BBB.15 (data-layer + CLI test coverage) shipped on branch `round2/phase-bbb-event-extensions`. BBB.3 (overrides/ dir layout) shipped as CLI surface; the wizard Screen 5 materializer remains in Phase CCC scope. BBB.4 / BBB.6 (UI surfaces + per-kind renderers), BBB.10 / BBB.11 (multi-reminder firing + briefings notifications), BBB.12 (post_event_checkin), BBB.13 (.ics / .eml / .pkpass importers) remain deferred to follow-up sub-agents.
